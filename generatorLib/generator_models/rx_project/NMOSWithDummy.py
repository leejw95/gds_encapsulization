...
class _NMOS(StickDiagram._StickDiagram):
    ...
    def _CalculateNMOSDesignParameter(self, _NMOSNumberofGate=6, _NMOSChannelWidth=600, _NMOSChannellength=30,
        ...
        if _NMOSDummy == False :
            ...
            if DesignParameters._Technology == 'TSMC65nm':
                self._DesignParameter['_PODummyLayer']['_YWidth'] = self._DesignParameter['_POLayer']['_YWidth']
        ...
        if _NMOSDummy and DesignParameters._Technology != 'SS28nm' and DesignParameters._Technology != 'TSMC65nm':
