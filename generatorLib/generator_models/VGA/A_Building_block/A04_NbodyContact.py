...
class _NbodyContact(StickDiagram_KJH0._StickDiagram_KJH):
...
if __name__ == '__main__':
    ...
    cellname = 'A04_NbodyContact'
    _fileName = cellname + '.gds'

    ''' Input Parameters for Layout Object '''
    InputParams = dict(
        _NumberOfNbodyCOX=10,
        _NumberOfNbodyCOY=2,
    )
    ...
    LayoutObj._CalculateNbodyContactDesignParameter(**InputParams)
