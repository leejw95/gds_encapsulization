...
class _ViaMet42Met5(StickDiagram_KJH0._StickDiagram_KJH):
...
if __name__ == '__main__':
    ...
    cellname = 'A11_ViaMet42Met5_99'
    _fileName = cellname + '.gds'

    ''' Input Parameters for Layout Object '''
    InputParams = dict(
        _ViaMet42Met5NumberOfCOX=6,
        _ViaMet42Met5NumberOfCOY=6,
    )
    ...
    LayoutObj = _ViaMet42Met5(_DesignParameter=None, _Name=cellname)
    LayoutObj._CalculateViaMet42Met5DesignParameter(**InputParams)
