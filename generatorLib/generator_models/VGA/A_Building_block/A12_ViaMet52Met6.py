...
class _ViaMet52Met6(StickDiagram_KJH0._StickDiagram_KJH):
...
if __name__ == '__main__':
    ...
    cellname = 'A12_ViaMet52Met6_99'
    _fileName = cellname + '.gds'

    ''' Input Parameters for Layout Object '''
    InputParams = dict(
        _ViaMet52Met6NumberOfCOX=7,
        _ViaMet52Met6NumberOfCOY=7,
    )
    ...
    LayoutObj = _ViaMet52Met6(_DesignParameter=None, _Name=cellname)
    LayoutObj._CalculateViaMet52Met6DesignParameter(**InputParams)
