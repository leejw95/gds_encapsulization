...
## ########################################################################################################################################################## Class_HEADER
class _unit(StickDiagram_KJH1._StickDiagram_KJH):
...
_down_margin 		= None,
        ...
        _Caculation_Parameters = copy.deepcopy(F01_guardring._guardring._ParametersForDesignCalculation)
        ...
        # Generate Sref
        self._DesignParameter['_Unit'] = self._SrefElementDeclaration(_DesignObj=F01_guardring._guardring(_DesignParameter=None, _Name='{}:_Unit'.format(_Name)))[0]

        # Define Sref Relection
        self._DesignParameter['_Unit']['_Reflect'] = [0, 0, 0]

        # Define Sref Angle
        self._DesignParameter['_Unit']['_Angle'] = 0

        # Calculate Sref Layer by using Calculation_Parameter
        self._DesignParameter['_Unit']['_DesignObj']._CalculateDesignParameter(**_Caculation_Parameters)

        # Define Sref _XYcoordinate
        self._DesignParameter['_Unit']['_XYCoordinates'] = [[0, 0]]
