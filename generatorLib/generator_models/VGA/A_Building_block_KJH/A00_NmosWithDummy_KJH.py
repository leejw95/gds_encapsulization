...
## ########################################################################################################################################################## Class_HEADER
class _NmosWithDummy_KJH(StickDiagram_KJH1._StickDiagram_KJH):
...
_NMOSDummy_placement = None, #None/'Up'/'Dn'/
        ...
        _XYCoordinateOfNMOS = [tmp[0][0]['_XY_cent']]
       ...
       #Define Boundary_element
        ...
        if _NMOSDummy == True:
            ...
            if _NMOSDummy_length == None:
                ...
                self._DesignParameter['_PODummyLayer']['_YWidth'] = _NMOSDummy_length
...
if __name__ == '__main__':
    ...
    cellname = 'A00_NmosWithDummy_KJH_99'
...
_NMOSDummy = True,  #TF
    #if _PMOSDummy == True
_NMOSDummy_length = 100, #None/Value
_NMOSDummy_placement = 'Dn', #None/'Up'/'Dn'/
    ...
    LayoutObj = _NmosWithDummy_KJH(_DesignParameter=None, _Name=cellname)
