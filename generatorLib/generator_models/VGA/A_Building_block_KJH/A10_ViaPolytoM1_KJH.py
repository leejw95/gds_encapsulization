...
_ViaPoly2Met1NumberOfCOY=None,
        ...
        #Define Boundary_element _XWidth
        self._DesignParameter['_POLayer']['_XWidth'] = _DRCObj._CoMinWidth + (_ViaPoly2Met1NumberOfCOX - 1) * _LengthViaPoly2Met1BtwCO + 2 * 4
        ...
        #Define Boundary_element _XWidth
        self._DesignParameter['_Met1Layer']['_XWidth'] = _DRCObj._CoMinWidth + (_ViaPoly2Met1NumberOfCOX - 1) * _LengthViaPoly2Met1BtwCO + 2 * _DRCObj._Metal1MinEnclosureCO
...
_ViaPoly2Met1NumberOfCOY=None,
        ...
        _LengthViaPoly2Met1BtwCO = _DRCObj._CoMinWidth + _DRCObj.DRCCOMinSpace(NumOfCOX=_ViaPoly2Met1NumberOfCOX, NumOfCOY=_ViaPoly2Met1NumberOfCOY)		
        #Define Boundary_element _YWidth
        self._DesignParameter['_POLayer']['_YWidth'] = _DRCObj._CoMinWidth + (_ViaPoly2Met1NumberOfCOY - 1) * _LengthViaPoly2Met1BtwCO + 2 * 4
        ...
        #Define Boundary_element _YWidth
        self._DesignParameter['_Met1Layer']['_YWidth'] = _DRCObj._CoMinWidth + (_ViaPoly2Met1NumberOfCOY - 1) * _LengthViaPoly2Met1BtwCO + 2 * _DRCObj._Metal1MinEnclosureCO
