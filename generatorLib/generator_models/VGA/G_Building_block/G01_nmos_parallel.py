...
## ########################################################################################################################################################## Class_HEADER
class _nmos_parallel(StickDiagram_KJH1._StickDiagram_KJH):
...
_Num_NMOS				= None,
        ...
        _Caculation_Parameters = copy.deepcopy(G00_nmos_input._nmos_input._ParametersForDesignCalculation)
        ...
        _Caculation_Parameters['_In_NMOSDummy_placement'] 	= _In_NMOSDummy_placement
            ...
            # Generate Sref
        self._DesignParameter['_Unit_tr'] = self._SrefElementDeclaration(_DesignObj=G00_nmos_input._nmos_input(_DesignParameter=None, _Name='{}:_Unit_tr'.format(_Name)))[0]

            # Define Sref Relection
        self._DesignParameter['_Unit_tr']['_Reflect'] = [0, 0, 0]

            # Define Sref Angle
        self._DesignParameter['_Unit_tr']['_Angle'] = 0

            # Calculate Sref Layer by using Calculation_Parameter
        self._DesignParameter['_Unit_tr']['_DesignObj']._CalculateDesignParameter(**_Caculation_Parameters)

            # Define Sref _XYcoordinate
        self._DesignParameter['_Unit_tr']['_XYCoordinates'] = [[0,0]]
        ...
        for i in range(0,_Num_NMOS):

            if i ==0:
                tmpXY.append([0,0])
                self._DesignParameter['_Unit_tr']['_XYCoordinates'] = tmpXY
            else:
                    #Calculate
                        #Target_coord
                tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr','_PODummyLayer')
                target_coord = tmp1[i-1][0][-1][0]['_XY_cent']
                        #Approaching_coord
                tmp2 = self.get_param_KJH3('_Unit_tr','_Input_tr','_PODummyLayer')
                approaching_coord = tmp2[i-1][0][0][0]['_XY_cent']
                        #Sref coord
                tmp3 = self.get_param_KJH3('_Unit_tr')
                Scoord = tmp3[i-1][0]['_XY_cent']
                        #Cal
            ...
            ## ################################################################################################################### _Unit_tr XVT cover-up
        # Define Boundary_element
        self._DesignParameter['_Unit_tr_xvt_coverup'] = self._BoundaryElementDeclaration(
        ...
        tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr','_{}Layer'.format(_In_XVT))
        self._DesignParameter['_Unit_tr_xvt_coverup']['_XWidth'] = abs( tmp1[-1][0][0][0]['_XY_right'][0] - tmp1[0][0][0][0]['_XY_left'][0] )

        # Define Boundary_element _YWidth
        tmp2 = self.get_param_KJH3('_Unit_tr','_Input_tr','_{}Layer'.format(_In_XVT))
        self._DesignParameter['_Unit_tr_xvt_coverup']['_YWidth'] = tmp2[0][0][0][0]['_Ywidth']

        #Calculate Sref XYcoord
        tmpXY=[]
            #initialized Sref coordinate
        self._DesignParameter['_Unit_tr_xvt_coverup']['_XYCoordinates'] = [[0,0]]
            #Calculate
                #Target_coord
        tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr','_{}Layer'.format(_In_XVT))
        target_coord = tmp1[0][0][0][0]['_XY_down_left']
                #Approaching_coord
        tmp2 = self.get_param_KJH3('_Unit_tr_xvt_coverup')
        approaching_coord = tmp2[0][0]['_XY_down_left']
                #Sref coord
        tmp3 = self.get_param_KJH3('_Unit_tr_xvt_coverup')
        ...
        tmpXY.append(New_Scoord)
            #Define
        self._DesignParameter['_Unit_tr_xvt_coverup']['_XYCoordinates'] = tmpXY
        
            ## ################################################################################################################### _Unit_tr source M2 connection
        # Define Boundary_element
        self._DesignParameter['_Unit_tr_source_m2_connection'] = self._BoundaryElementDeclaration(
        ...
        # Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr_source_m2_hrz')
        self._DesignParameter['_Unit_tr_source_m2_connection']['_XWidth'] = abs( tmp1[-1][0][0]['_XY_right'][0] - tmp1[0][0][0]['_XY_left'][0] )

        # Define Boundary_element _YWidth
        tmp2 = self.get_param_KJH3('_Unit_tr','_Input_tr_source_m2_hrz')
        self._DesignParameter['_Unit_tr_source_m2_connection']['_YWidth'] = tmp2[0][0][0]['_Ywidth']

        #Calculate Sref XYcoord
        tmpXY=[]
            #initialized Sref coordinate
        self._DesignParameter['_Unit_tr_source_m2_connection']['_XYCoordinates'] = [[0,0]]
            #Calculate
                #Target_coord
        tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr_source_m2_hrz')
        target_coord = tmp1[0][0][0]['_XY_down_left']
                #Approaching_coord
        tmp2 = self.get_param_KJH3('_Unit_tr_source_m2_connection')
        approaching_coord = tmp2[0][0]['_XY_down_left']
                #Sref coord
        tmp3 = self.get_param_KJH3('_Unit_tr_source_m2_connection')
        Scoord = tmp3[0][0]['_XY_cent']
                #Cal
        New_Scoord = self.get_Scoord_KJH(target_coord,approaching_coord,Scoord)
        New_Scoord = np.round(New_Scoord,2)
        tmpXY.append(New_Scoord)
            #Define
        self._DesignParameter['_Unit_tr_source_m2_connection']['_XYCoordinates'] = tmpXY
        
            ## ################################################################################################################### Unit_Tr_Source_ViaM2M5
        ...
        self._DesignParameter['_Unit_tr_source_ViaM2M5'] = self._SrefElementDeclaration(_DesignObj=A18_ViaStack_KJH._ViaStack_KJH(_DesignParameter=None, _Name='{}:_Unit_tr_source_ViaM2M5'.format(_Name)))[0]

        #Define Sref Relection
        self._DesignParameter['_Unit_tr_source_ViaM2M5']['_Reflect'] = [0, 0, 0]
        
        #Define Sref Angle
        self._DesignParameter['_Unit_tr_source_ViaM2M5']['_Angle'] = 0

        #Calcuate Overlapped XYcoord
        tmp1 = self.get_param_KJH3('_Unit_tr_source_m2_connection')

        #Calcuate _COX and _COY
        _COX, _COY= self._CalculateNumViaByXYWidth(tmp1[0][0]['_Xwidth'],tmp1[0][0]['_Ywidth'],'MinEnclosureY')  ## None or 'MinEnclosureX' or 'MinEnclosureY'
        ...
        self._DesignParameter['_Unit_tr_source_ViaM2M5']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters) ## Option: Xmin, Ymin

        #Calculate Sref XYcoord
        tmpXY=[]
            #initialized Sref coordinate
        self._DesignParameter['_Unit_tr_source_ViaM2M5']['_XYCoordinates'] = [[0,0]]
            #Calculate
                #Target_coord
        tmp1 = self.get_param_KJH3('_Unit_tr_source_m2_connection') 
        target_coord = tmp1[0][0]['_XY_cent']
                #Approaching_coord
        tmp2 = self.get_param_KJH3('_Unit_tr_source_ViaM2M5','_ViaM2M3','_Met2Layer')  
        approaching_coord = tmp2[0][0][0][0]['_XY_cent']
                #Sref coord
        tmp3 = self.get_param_KJH3('_Unit_tr_source_ViaM2M5')
        Scoord = tmp3[0][0]['_XY_cent']
                #Cal
        New_Scoord = self.get_Scoord_KJH(target_coord,approaching_coord,Scoord)
        New_Scoord = np.round(New_Scoord,2)
        tmpXY.append(New_Scoord)
            #Define
        self._DesignParameter['_Unit_tr_source_ViaM2M5']['_XYCoordinates'] = tmpXY

            ## ################################################################################################################### _Unit_tr drain M2 connection
        # Define Boundary_element
        self._DesignParameter['_Unit_tr_drain_m2_connection'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL2'][0],
            _Datatype=DesignParameters._LayerMapping['METAL2'][1],
            _XWidth=None,
            _YWidth=None,
        ...
        # Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr_drain_m2_hrz')
        self._DesignParameter['_Unit_tr_drain_m2_connection']['_XWidth'] = abs( tmp1[-1][0][0]['_XY_right'][0] - tmp1[0][0][0]['_XY_left'][0] )

        # Define Boundary_element _YWidth
        tmp2 = self.get_param_KJH3('_Unit_tr','_Input_tr_drain_m2_hrz')
        self._DesignParameter['_Unit_tr_drain_m2_connection']['_YWidth'] = tmp2[0][0][0]['_Ywidth']

        #Calculate Sref XYcoord
        tmpXY=[]
            #initialized Sref coordinate
        self._DesignParameter['_Unit_tr_drain_m2_connection']['_XYCoordinates'] = [[0,0]]
            #Calculate
                #Target_coord
        tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr_drain_m2_hrz')
        target_coord = tmp1[0][0][0]['_XY_down_left']
                #Approaching_coord
        tmp2 = self.get_param_KJH3('_Unit_tr_drain_m2_connection')
        approaching_coord = tmp2[0][0]['_XY_down_left']
                #Sref coord
        tmp3 = self.get_param_KJH3('_Unit_tr_drain_m2_connection')
        Scoord = tmp3[0][0]['_XY_cent']
                #Cal
        New_Scoord = self.get_Scoord_KJH(target_coord,approaching_coord,Scoord)
        New_Scoord = np.round(New_Scoord,2)
        tmpXY.append(New_Scoord)
            #Define
        self._DesignParameter['_Unit_tr_drain_m2_connection']['_XYCoordinates'] = tmpXY

            ## ################################################################################################################### Unit_Tr_Drain_ViaM2M5
        #Define ViaX Parameter
        _Caculation_Parameters = copy.deepcopy(A18_ViaStack_KJH._ViaStack_KJH._ParametersForDesignCalculation)
        _Caculation_Parameters['_Layer1'] 	= 2
        _Caculation_Parameters['_Layer2'] 	= 5
        ...
        #Sref ViaX declaration
        self._DesignParameter['_Unit_tr_drain_ViaM2M5'] = self._SrefElementDeclaration(_DesignObj=A18_ViaStack_KJH._ViaStack_KJH(_DesignParameter=None, _Name='{}:_Unit_tr_drain_ViaM2M5'.format(_Name)))[0]

        #Define Sref Relection
        self._DesignParameter['_Unit_tr_drain_ViaM2M5']['_Reflect'] = [0, 0, 0]
        
        #Define Sref Angle
        self._DesignParameter['_Unit_tr_drain_ViaM2M5']['_Angle'] = 0

        #Calcuate Overlapped XYcoord
        tmp1 = self.get_param_KJH3('_Unit_tr_drain_m2_connection')
        ...
        #Generate Metal(x), Metal(x+1) and C0(Viax) layer
        self._DesignParameter['_Unit_tr_drain_ViaM2M5']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters) ## Option: Xmin, Ymin

        #Calculate Sref XYcoord
        tmpXY=[]
            #initialized Sref coordinate
        self._DesignParameter['_Unit_tr_drain_ViaM2M5']['_XYCoordinates'] = [[0,0]]
            #Calculate
                #Target_coord
        tmp1 = self.get_param_KJH3('_Unit_tr_drain_m2_connection') 
        target_coord = tmp1[0][0]['_XY_cent']
                #Approaching_coord
        tmp2 = self.get_param_KJH3('_Unit_tr_drain_ViaM2M5','_ViaM2M3','_Met2Layer')  
        approaching_coord = tmp2[0][0][0][0]['_XY_cent']
                #Sref coord
        tmp3 = self.get_param_KJH3('_Unit_tr_drain_ViaM2M5')
        Scoord = tmp3[0][0]['_XY_cent']
                #Cal
        New_Scoord = self.get_Scoord_KJH(target_coord,approaching_coord,Scoord)
        New_Scoord = np.round(New_Scoord,2)
        tmpXY.append(New_Scoord)
            #Define
        self._DesignParameter['_Unit_tr_drain_ViaM2M5']['_XYCoordinates'] = tmpXY

            ## ################################################################################################################### _Unit_tr Gate M3 connection
        # Define Boundary_element
        self._DesignParameter['_Unit_tr_gate_m3_connection'] = self._BoundaryElementDeclaration(
        ...
        # Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr_ViaM0M3','_ViaM2M3','_Met3Layer')
        self._DesignParameter['_Unit_tr_gate_m3_connection']['_XWidth'] = abs( tmp1[-1][0][0][0][0]['_XY_right'][0] - tmp1[0][0][0][0][0]['_XY_left'][0] )

        # Define Boundary_element _YWidth
        tmp2 = self.get_param_KJH3('_Unit_tr','_Input_tr_ViaM0M3','_ViaM2M3','_Met3Layer')
        self._DesignParameter['_Unit_tr_gate_m3_connection']['_YWidth'] = tmp2[0][0][0][0][0]['_Ywidth']

        #Calculate Sref XYcoord
        tmpXY=[]
            #initialized Sref coordinate
        self._DesignParameter['_Unit_tr_gate_m3_connection']['_XYCoordinates'] = [[0,0]]
            #Calculate
                #Target_coord
        tmp1 = self.get_param_KJH3('_Unit_tr','_Input_tr_ViaM0M3','_ViaM2M3','_Met3Layer')
        target_coord = tmp1[0][0][0][0][0]['_XY_down_left']
                #Approaching_coord
        tmp2 = self.get_param_KJH3('_Unit_tr_gate_m3_connection')
        approaching_coord = tmp2[0][0]['_XY_down_left']
                #Sref coord
        tmp3 = self.get_param_KJH3('_Unit_tr_gate_m3_connection')
        Scoord = tmp3[0][0]['_XY_cent']
                #Cal
        New_Scoord = self.get_Scoord_KJH(target_coord,approaching_coord,Scoord)
        New_Scoord = np.round(New_Scoord,2)
        tmpXY.append(New_Scoord)
            #Define
        self._DesignParameter['_Unit_tr_gate_m3_connection']['_XYCoordinates'] = tmpXY
...
_Num_NMOS				= 7,
    ...
    LayoutObj = _nmos_parallel(_DesignParameter=None, _Name=cellname)
