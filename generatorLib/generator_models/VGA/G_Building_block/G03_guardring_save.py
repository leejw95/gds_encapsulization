...
_down_margin 		= None,
        ...
        tmp3 = self.get_param_KJH3('_Pbodyring','_ExtenMet1Layer_Bottom')
        self._DesignParameter['_Dummy_sd_m1_conn']['_YWidth'] = abs( tmp2[0][0][0][0]['_XY_down'][1] - tmp3[0][0][0]['_XY_up'][1] ) 
