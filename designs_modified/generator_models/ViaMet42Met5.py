...
class _ViaMet42Met5(StickDiagram._StickDiagram):
    ...
    def _CalculateViaMet42Met5DesignParameter(self, _NumberOfCOX=None, _NumberOfCOY=None ):
        print('#########################################################################################################')
        ...
        _LengthViaMet42Met5BtwCO = _DRCObj._VIAxMinWidth + _DRCObj.DRCVIAxMinSpace(NumOfVIAxX=_NumberOfCOX,NumOfVIAxY=_NumberOfCOY )
        self._DesignParameter['_Met5Layer']['_XYCoordinates']=_XYCoordinateOfViaMet42Met5
        self._DesignParameter['_Met5Layer']['_XWidth']=_DRCObj._VIAxMinWidth + (_NumberOfCOX - 1)* _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])
        self._DesignParameter['_Met5Layer']['_YWidth']=_DRCObj._VIAxMinWidth + (_NumberOfCOY - 1)* _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])

        print('#############################     Met2 Layer Calculation   ##############################################')
        _LengthViaMet42Met5BtwCO = _DRCObj._VIAxMinWidth + _DRCObj.DRCVIAxMinSpace(NumOfVIAxX=_NumberOfCOX,NumOfVIAxY=_NumberOfCOY )

        self._DesignParameter['_Met4Layer']['_XYCoordinates']=_XYCoordinateOfViaMet42Met5
        self._DesignParameter['_Met4Layer']['_XWidth'] = _DRCObj._VIAxMinWidth + (_NumberOfCOX - 1)*  _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])
        self._DesignParameter['_Met4Layer']['_YWidth'] = _DRCObj._VIAxMinWidth + (_NumberOfCOY - 1)*  _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])
        ...
        for i in range(0, _NumberOfCOX):
            for j in range(0, _NumberOfCOY):
                ...
                if (_NumberOfCOX % 2) == 0 and (_NumberOfCOY % 2)==0:
                    _xycoordinatetmp = [_XYCoordinateOfViaMet42Met5[0][0] - (_NumberOfCOX / 2 - 0.5) * _LengthViaMet42Met5BtwCO + i * _LengthViaMet42Met5BtwCO,
                                        _XYCoordinateOfViaMet42Met5[0][1] - (_NumberOfCOY / 2 - 0.5 )*_LengthViaMet42Met5BtwCO + j*_LengthViaMet42Met5BtwCO]

                elif (_NumberOfCOX % 2) == 0 and (_NumberOfCOY % 2)==1:
                    _xycoordinatetmp = [_XYCoordinateOfViaMet42Met5[0][0] - (_NumberOfCOX / 2 - 0.5) * _LengthViaMet42Met5BtwCO + i * _LengthViaMet42Met5BtwCO,
                                        _XYCoordinateOfViaMet42Met5[0][1] - (_NumberOfCOY-1)/2 * _LengthViaMet42Met5BtwCO +j*_LengthViaMet42Met5BtwCO]

                elif (_NumberOfCOX % 2) == 1 and (_NumberOfCOY % 2)==0:
                    _xycoordinatetmp = [_XYCoordinateOfViaMet42Met5[0][0] - (_NumberOfCOX -1) / 2  * _LengthViaMet42Met5BtwCO + i * _LengthViaMet42Met5BtwCO,
                                        _XYCoordinateOfViaMet42Met5[0][1] - (_NumberOfCOY / 2 - 0.5 )*_LengthViaMet42Met5BtwCO + j*_LengthViaMet42Met5BtwCO]
    ...
    def _CalculateViaMet42Met5DesignParameterMinimumEnclosureX(self, _NumberOfCOX=None, _NumberOfCOY=None ):
        ...
        _LengthViaMet42Met5BtwCO = _DRCObj._VIAxMinWidth + _DRCObj.DRCVIAxMinSpace(NumOfVIAxX=_NumberOfCOX,NumOfVIAxY=_NumberOfCOY )
        self._DesignParameter['_Met5Layer']['_XYCoordinates']=_XYCoordinateOfViaMet42Met5
        self._DesignParameter['_Met5Layer']['_XWidth']=_DRCObj._VIAxMinWidth+ (_NumberOfCOX - 1)* _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia1,_DRCObj._MetalxMinEnclosureCO])
        self._DesignParameter['_Met5Layer']['_YWidth']=_DRCObj._VIAxMinWidth + (_NumberOfCOY - 1)* _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])
        ...
        self._DesignParameter['_Met4Layer']['_XYCoordinates']=_XYCoordinateOfViaMet42Met5
        self._DesignParameter['_Met4Layer']['_XWidth'] = _DRCObj._VIAxMinWidth + (_NumberOfCOX - 1)*  _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia1,_DRCObj._MetalxMinEnclosureCO])
    ...
    def _CalculateViaMet42Met5DesignParameterMinimumEnclosureY(self, _NumberOfCOX=None, _NumberOfCOY=None ):
        ...
        self._DesignParameter['_Met5Layer']['_XYCoordinates']=_XYCoordinateOfViaMet42Met5
        self._DesignParameter['_Met5Layer']['_XWidth']=_DRCObj._VIAxMinWidth+ (_NumberOfCOX - 1)* _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])
        self._DesignParameter['_Met5Layer']['_YWidth']=_DRCObj._VIAxMinWidth + (_NumberOfCOY - 1)* _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia1,_DRCObj._MetalxMinEnclosureCO])
        ...
        self._DesignParameter['_Met4Layer']['_YWidth'] = _DRCObj._VIAxMinWidth + (_NumberOfCOY - 1)*  _LengthViaMet42Met5BtwCO+ 2 * max([_DRCObj._Metal1MinEnclosureVia1,_DRCObj._MetalxMinEnclosureCO])
