...
class _NbodyContact(StickDiagram._StickDiagram):
    ...
    def _CalculateNbodyContactDesignParameter(self, _NumberOfBodyCOX=None, _NumberOfBodyCOY=None,  _Met1XWidth=None, _Met1YWidth=None ):
        print('#########################################################################################################')
        ...
        _LengthNbodyBtwCO = _DRCObj._CoMinWidth + _DRCObj.DRCCOMinSpace(NumOfCOX=_NumberOfBodyCOX,NumOfCOY=_NumberOfBodyCOY )
        ...
        self._DesignParameter['_ODLayer']['_XWidth'] = _DRCObj._CoMinWidth + (_NumberOfBodyCOX - 1) * _LengthNbodyBtwCO + 2 * _DRCObj._CoMinEnclosureByODAtLeastTwoSide
        self._DesignParameter['_ODLayer']['_YWidth'] = _DRCObj._CoMinWidth + (_NumberOfBodyCOY - 1) * _LengthNbodyBtwCO + 2 * _DRCObj._CoMinEnclosureByODAtLeastTwoSide
        ...
        for i in range(0, _NumberOfBodyCOX):
            for j in range(0, _NumberOfBodyCOY):
                ...
                if (_NumberOfBodyCOX % 2) == 0 and (_NumberOfBodyCOY % 2)==0:
                    _xycoordinatetmp = [_XYCoordinateOfNbodyContact[0][0] - (_NumberOfBodyCOX / 2 - 0.5) * _LengthNbodyBtwCO + i * _LengthNbodyBtwCO,
                                        _XYCoordinateOfNbodyContact[0][1] - (_NumberOfBodyCOY / 2 - 0.5) * _LengthNbodyBtwCO + j * _LengthNbodyBtwCO]
                elif (_NumberOfBodyCOX % 2) == 0 and (_NumberOfBodyCOY % 2)==1:
                    _xycoordinatetmp = [_XYCoordinateOfNbodyContact[0][0] - (_NumberOfBodyCOX / 2 - 0.5) * _LengthNbodyBtwCO + i * _LengthNbodyBtwCO,
                                        _XYCoordinateOfNbodyContact[0][1] - (_NumberOfBodyCOY-1)/2*_LengthNbodyBtwCO +j*_LengthNbodyBtwCO]

                elif (_NumberOfBodyCOX % 2) == 1 and (_NumberOfBodyCOY % 2)==0:
                    _xycoordinatetmp = [_XYCoordinateOfNbodyContact[0][0] - (_NumberOfBodyCOX -1) / 2  * _LengthNbodyBtwCO + i * _LengthNbodyBtwCO,
                                        _XYCoordinateOfNbodyContact[0][1] - (_NumberOfBodyCOY / 2 - 0.5) * _LengthNbodyBtwCO + j * _LengthNbodyBtwCO]
...
if __name__=='__main__':
    ...
    NbodyContactObj._CalculateNbodyContactDesignParameter( _NumberOfBodyCOX=3, _NumberOfBodyCOY=1,)
